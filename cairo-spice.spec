%define pixman_spice_version 0.13.3
%define freetype_version 2.1.9
%define fontconfig_version 2.0

%define gitrev 74d6b5
%define tarversion 1.8.7.1-git%{gitrev}
%define pkgversion 1.8.7.1
...
BuildRequires: pixman-spice-devel >= %{pixman_spice_version}
...
%package devel
Summary: Development files for cairo-spice
Group: Development/Libraries
Requires: %{name} = %{version}-%{release}
Requires: libXrender-devel
Requires: libpng-devel
Requires: pixman-spice-devel >= %{pixman_spice_version}
...
%{_libdir}/libcairo-spice*.so
%{_libdir}/pkgconfig/*
%{_datadir}/gtk-doc/html/cairo-spice

%changelog
* Tue Jan 12 2010 Matthias Clasen <mclasen@redhat.com> - 1.8.7.1-4
- Fix the build

* Wed Dec  9 2009 Uri Lublin <uril@redhat.com> 1.8.7.1-3
- Rename package and files from qcairo to cairo-spice

* Thu Apr 23 2009 Soren Sandmann <sandmann@redhat.com> 1.8.7.1-3
- Add a paragraph to the description indicating that this is not
  the normal cairo.

* Tue Jan 27 2009 Eduardo Habkost <ehabkost@redhat.com> 1.8.7.1-2
- Update to new qcairo git snapshot: 74d6b5cca0900e93b11d8fd88565f09f1aa23993

* Wed Jan 14 2009 Soren Sandmann <sandmann@redhat.com> 1.8.7.1-1
- Update to qcairo version 1.8.7.1
